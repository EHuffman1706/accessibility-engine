...
- [Ethics, Consent, and Safety](#ethics-consent-and-safety)
...
![Accessibility Engine Concept Architecture](accessibility_engine_architecture_diagram.svg)

*Figure 1. Accessibility Engine concept architecture.*

Screen reader users can access a full text description here:

[Concept Architecture — Text Diagram](architecture_diagram_text.md)

---

![Accessibility Engine Advanced Architecture](accessibility_engine_advanced_architecture.svg)
...
[Plain Language Overview](PLAIN_LANGUAGE_OVERVIEW.md)
